    ...
    public partial class Init : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "e1@example.com", "John1", "Doe1" },
                    { 2, "e2@example.com", "John2", "Doe2" },
                    { 3, "e3@example.com", "John3", "Doe3" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "Description1", "Medicament1", "Type1" },
                    { 2, "Description2", "Medicament2", "Type2" },
                    { 3, "Description3", "Medicament3", "Type3" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new DateTime(2000, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "John1", "Doe1" },
                    { 2, new DateTime(2000, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "John2", "Doe2" },
                    { 3, new DateTime(2000, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "John3", "Doe3" }
                });
